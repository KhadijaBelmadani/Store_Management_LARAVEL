            ...
            <div class="card-body">
                <form action="{{ url('admin/colors/create') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input name="Nom" type="text" class="form-control" id="Nom" placeholder="Entrez le nom de la couleur" >
                        @error('Nom')
                      ...
                      <div class="form-group">
                        ...
                        <input name="Code" type="text" class="form-control" id="Code" placeholder="Entrez le code de la couleur" >
                        @error('Code')
                            <small class="text-danger">
                               * {{ $message }}
                            </small>
