...
<div class="py-5 bg-white">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 style="color:rgb(255, 170, 0);font-weight:bold" class=" text-center"><i class="fa-solid fa-magnifying-glass"></i>  Les resultats de la recherche</h4>
                <div class="underlinee mx-auto"></div><br><br>
            </div>


            @forelse ($searchProd as $productItem)
            <div class="col-md-3">
                ...
                @empty
                    ...
                    <div class="col-md-12 p-2">
                        <h5>Pas De Produits Disponibles </h5>
